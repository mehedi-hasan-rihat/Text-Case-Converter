                ...
                {isExpanded && (
                    <div className="border-t border-gray-100 p-6">
                        <div className="flex gap-3 mb-4">
                            ...
                            <button
                                onClick={onClearAll}
                                className="px-3 py-2 text-sm bg-blue-50 text-blue-600 rounded-lg hover:bg-gray-100 transition-colors duration-200"
                            >
                                Clear All
                            </button>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                            {availableFormats.map((format) => {
                                ...
                                return (
                                    <label
                                        key={format.id}
                                        className={`flex items-start gap-3 p-3 rounded-lg cursor-pointer transition-all duration-200 ${isSelected
